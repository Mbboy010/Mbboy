...
const skills = [
  ...
  },
  {
    ...
    icon: <SiLinux className="text-4xl text-gray-300" />,
  },
  {
    ...
    icon: <SiWireshark className="text-4xl text-cyan-400" />,
  },
];
    ...
    <section className="relative bg-[#0B0B0F] text-white py-20 overflow-hidden">
      ...
      <Container>
        ...
        >
          ...
          >
            My <span className="text-purple-400">Development & Security Stack</span>
          </motion.h2>
          ...
          >
            I blend creativity with cybersecurity expertise — developing high-performance, secure, and
            visually stunning digital experiences using modern technologies and security practices.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {skills.map((skill, index) => (
            <motion.div
              ...
              viewport={{ once: false, amount: 0.3 }}
              className="bg-gradient-to-br from-[#1a1a2e] to-[#111] rounded-2xl p-6 text-center shadow-lg 
                         hover:shadow-purple-500/40 transition-all hover:scale-[1.03]"
            >
