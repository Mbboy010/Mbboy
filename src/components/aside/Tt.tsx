  ...
  return (
    <div className="relative" style={{ zIndex: "100" }}>
      ...
      <div className="fixed left-0 top-0 w-screen">
        ...
        >
          <Link href="/">
            <h1 className="text-2xl ml-1 md:ml-4 lg:ml-7 font-bold bg-gradient-to-r from-[#F86E01] to-red-500 text-transparent bg-clip-text">
              MBBOY
            </h1>
          </Link>

          <div className="text-white transition md:mr-4 lg:mr-7 flex gap-1">
            <Switch
            ...
            <Menu
              onClick={handleAside}
              className="text-[3rem] mr-1 hover:text-[#F86E01]"
            />
          </div>
        </motion.nav>
      </div>
