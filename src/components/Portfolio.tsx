          ...
          {projects.map((p, i) => {
            ...
            return (
              <motion.div
                ...
                className="relative group bg-gradient-to-br from-[#1a1a2e] to-[#111] rounded-2xl shadow-lg hover:shadow-purple-500/40 transition-all duration-700 overflow-hidden"
              >
                {/* Image Wrapper */}
                <motion.div
                ...
                {/* Project Info */}
                <div className="p-5 text-center bg-[#151320] rounded-b-2xl">
                ...
                {/* Hover Glow */}
                <div className="absolute inset-0 bg-purple-600/10 opacity-0 group-hover:opacity-100 blur-2xl transition-all duration-700 -z-10"></div>
              </motion.div>
            );
          })}
        </div>
