  ...
  return (
    <section className="relative py-32 overflow-hidden text-gray-900 dark:text-white transition-colors duration-500">
      ...
      <Container className="relative z-10">
            ...
            >
              ...
              <div className="relative w-full h-60 overflow-hidden bg-gray-100 dark:bg-gray-800">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                  <a 
                    href={p.demo} 
                    className="p-3 rounded-full bg-white text-gray-900 hover:bg-purple-500 hover:text-white transition-colors transform hover:scale-110"
                    title="Live Demo"
                  >
              ...
              <div className="flex flex-col flex-grow p-6">
                <div className="flex flex-wrap gap-2 mb-4">
                  {p.tags.map(tag => (
                    <span key={tag} className="text-xs font-medium px-2.5 py-1 rounded-md bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-300 border border-purple-100 dark:border-purple-800/50">
                      {tag}
                    </span>
                  ))}
                </div>
        ...
        >
          <Link href="/works" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-bold hover:bg-purple-600 dark:hover:bg-gray-200 transition-colors shadow-lg hover:shadow-purple-500/25">
            View All Projects
            <FaArrowRight />
          </Link>
        </motion.div>
